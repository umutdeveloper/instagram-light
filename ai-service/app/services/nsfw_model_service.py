    ...
    def load_model(self):
        if self.model is None:
            ...
            try:
                ...
                self.processor = AutoImageProcessor.from_pretrained(settings.IMAGE_MODERATION_MODEL_NAME)
                self.model = AutoModelForImageClassification.from_pretrained(settings.IMAGE_MODERATION_MODEL_NAME)
